  ...
  return (
    <Sidebar collapsible="icon" className="border-r bg-slate-50/50 dark:bg-slate-950/50 backdrop-blur-3xl transition-colors duration-500">
      ...
      <SidebarContent className="px-0 space-y-0 overflow-x-hidden">
        <SidebarGroup className="py-2 bg-blue-600 dark:bg-blue-700 text-white group-data-[collapsible=icon]:bg-transparent group-data-[collapsible=icon]:text-inherit group-data-[collapsible=icon]:py-2 group-data-[collapsible=icon]:px-0">
              ...
              {mainItems.map((item) => (
                <SidebarMenuItem key={item.title} className="group-data-[collapsible=icon]:flex group-data-[collapsible=icon]:justify-center">
                  <SidebarMenuButton
                    ...
                    className="text-white/90 hover:bg-white/10 hover:text-white transition-all group-data-[collapsible=icon]:text-inherit group-data-[collapsible=icon]:hover:bg-accent group-data-[collapsible=icon]:hover:text-accent-foreground data-[active=true]:bg-white/20 data-[active=true]:text-white"
                  >
                    <item.icon />
